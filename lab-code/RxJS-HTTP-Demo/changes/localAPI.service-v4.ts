...
export class LocalAPIService {
    ...
    deleteExistingHero(heroId: number) : Observable<HttpResponse<any>> {

        // For DELETE, we just need the id of a resource that we want to delete
        // no body in the request is required 
        let finalUrl = this.baseUrl + "/" + heroId;
        
        return this.http.delete(finalUrl, { observe: 'response' });
    }
}
